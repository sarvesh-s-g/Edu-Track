...
def attendance(request, stud_id):
    ...
    # Build a list of attendance totals along with the teacher who takes that course
    att_list = []
    for ass in ass_list:
        try:
            ...
            a.save()
        # append a dict with attendance total and the teacher for this assignment
        att_list.append({'att': a, 'teacher': ass.teacher})
